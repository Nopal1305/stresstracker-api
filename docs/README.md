...
```json
{
    "code": 201,
    "status": "success",
    "message": "Registrasi tahap 1 berhasil! Silakan cek email untuk kode verifikasi.",
    "data": {
        "userId": "user-VelbsTgacCOusP5l",
        "email": "ricardomls1305@gmail.com"
    }
}
```
...
```json
{
    ...
    "data": {
        "user": {
            "id": "user-VelbsTgacCOusP5l",
            "email": "ricardomls1305@gmail.com",
            "username": "novanakmeletup",
...
### Reset Password (Verifikasi OTP & Password Baru)
* URL: `/reset-password`,
* Method: `POST`
...
### Ubah Password (Bagi User yang Sedang Login)
* URL: `/change-password`,
* Method: `PUT`
